...
class NHP_Options{
	...
	protected $cake_url = 'http://ebookcake.com/';
...
//		$defaults['footer_credit'] =  '<span id="footer-thankyou">' . __('Options Panel created using the','nhp-opts') . '<a href="'.$this->framework_url.'" target="_blank">' . __('NHP Theme Options Framework','nhp-opts') . '</a>' . __('Version','nhp-opts') . ' '.$this->framework_version.'</span>';

		$defaults['footer_credit'] =  '<span id="footer-thankyou"><a href="'.$this->cake_url.'" target="_blank">' . __("eBookCake","nhp-opts") . '</a></span>';
